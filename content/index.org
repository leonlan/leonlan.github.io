...
My work focuses on routing and scheduling problems motivated by industrial applications.
I like to solve these problems by building simple methods and easy-to-use software.
...
1. *Lan, L*., & Zocca, A. (2025). Mixed-integer linear programming approaches for tree partitioning of power networks. IEEE Transactions on Control of Network Systems.
   [[https://ieeexplore.ieee.org/document/10872801][paper]] | [[https://doi.org/10.48550/arXiv.2110.07000][arXiv]] | [[https://github.com/leonlan/tree-partitioning][github]].
...
1. *Lan, L*., & Berkhout, J. (2024). PyJobShop: Solving scheduling problems with constraint programming in Python.
   [[https://arxiv.org/pdf/2502.13483][arXiv]] | [[https://github.com/PyJobShop/PyJobShop][github]].
